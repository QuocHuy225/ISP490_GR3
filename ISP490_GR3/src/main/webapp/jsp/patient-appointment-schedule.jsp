...
<html lang="vi">
            ...
            <div class="container">
                ...
                <section id="appointmentHistoryContent" class="tab-content">
                    ...
                    <div id="appointmentHistoryList" class="appointment-list">
                        <p class="no-appointments" id="noHistoryAppointments">Bạn chưa có lịch sử 
                        cuộc hẹn nào.</p>
                    </div>
                ...
                <div id="successMessageModal" class="modal">
                        ...
                        <p id="successMessageText" style="font-size: 1.1em;
                        text-align: center;"></p>
                        <div class="modal-actions justify-content-center">
                ...
                <div id="errorMessageModal" class="modal">
                    <div class="modal-content small-modal-content">
                        ...
                        <p id="errorMessageText" style="font-size: 1.1em;
                        text-align: center;"></p>
                        <div class="modal-actions justify-content-center">
                ...
                <div class="modal-content large-modal-content">
                    ...
                    <form id="newAppointmentForm">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="newAppointmentDate" name="appointmentDate" required 
                            disabled>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (sidebarCollapse && sidebar && content) { // Kiểm tra null 
            before adding event listener
