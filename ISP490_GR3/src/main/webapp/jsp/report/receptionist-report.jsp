...
<html lang="vi">
    <head>
        <meta charset="UTF-8">
        <title>Báo cáo chi tiết lịch hẹn - Ánh Dương Clinic</title>
    ...
    <body>
        ...
        <div id="content">
            ...
            <div class="container mt-5 pt-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h2 class="mb-0">Báo Cáo Chi Tiết Lịch Hẹn</h2>
                    <a href="${pageContext.request.contextPath}/receptionist/report" class="back-link">← Quay lại Dashboard</a>
                </div>
                ...
                <div class="row justify-content-center mb-4">
                    <div class="col-md-6 mb-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body">
                                <h5 class="card-title text-center">Lịch hẹn theo dịch vụ</h5>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6 mb-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body">
                                <h5 class="card-title text-center">Lịch hẹn theo bác sĩ</h5>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body">
                                <h5 class="card-title text-center">Bệnh nhân mới theo tháng</h5>
                                <canvas id="newPatientsByMonthChart"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            const appointmentsByStatus = ${appointmentsByStatusJson};
            const appointmentsByDoctor = ${appointmentsByDoctorJson};
            const newPatientsByMonth = ${newPatientsByMonthJson};

            new Chart(document.getElementById('appointmentsByServiceChart'), {
                type: 'bar',
                data: {
                    labels: appointmentsByService.map(e => e.service),
                    datasets: [{
                            label: 'Số lượng',
                            data: appointmentsByService.map(e => e.count),
                            backgroundColor: '#4e73df'
                        }]
                }
            });

            new Chart(document.getElementById('appointmentsByStatusChart'), {
                type: 'bar',
                data: {
                    labels: appointmentsByStatus.map(e => e.status),
                    datasets: [{
                            label: 'Số lượng',
                            data: appointmentsByStatus.map(e => e.count),
                            backgroundColor: '#1cc88a'
                        }]
                }
            });

            new Chart(document.getElementById('appointmentsByDoctorChart'), {
                type: 'bar',
                data: {
                    labels: appointmentsByDoctor.map(e => e.doctor),
                    datasets: [{
                            label: 'Số lượng',
                            data: appointmentsByDoctor.map(e => e.count),
                            backgroundColor: '#f6c23e'
                        }]
                }
            });

            new Chart(document.getElementById('newPatientsByMonthChart'), {
                type: 'bar',
                data: {
                    labels: newPatientsByMonth.map(e => e.month),
                    datasets: [{
                            label: 'Số lượng',
                            data: newPatientsByMonth.map(e => e.count),
