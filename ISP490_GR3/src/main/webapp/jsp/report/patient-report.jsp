...
<html lang="vi">
    <head>
        ...
        <title>Báo Cáo Bệnh Nhân - Ánh Dương Clinic</title>
        <!-- Google Fonts -->
        ...
        <div id="content">
            ...
            <div class="container-fluid mt-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2>Báo Cáo Thống Kê Bệnh Nhân</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="stat-card bg-primary bg-opacity-10">
                            <h5 class="text-primary">Tổng số bệnh nhân</h5>
                            <h2 class="mb-0">${patientStats.totalPatients}</h2>
                        </div>
                    </div>

                    <!-- Số bệnh nhân có lịch hẹn -->
                    <div class="col-md-4">
                        <div class="stat-card bg-success bg-opacity-10">
                            <h5 class="text-success">Bệnh nhân có lịch hẹn</h5>
                            <h2 class="mb-0">${patientStats.patientsWithAppointments}</h2>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="stat-card bg-info bg-opacity-10">
                            <h5 class="text-info">Tổng số lượt khám</h5>
                            <h2 class="mb-0">${patientStats.totalVisits}</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Phân bố giới tính bệnh nhân</h5>
                    ...
                    <!-- Biểu đồ tỷ lệ bệnh nhân có lịch hẹn -->
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Tỷ lệ bệnh nhân có lịch hẹn</h5>
                                <div class="chart-container">
        ...
        <script>
            ...
            new Chart(genderCtx, {
                ...
                data: {
                    labels: ['Nam', 'Nữ'],
                    datasets: [{
                        data: [${patientStats.maleCount}, ${patientStats.femaleCount}],
            ...
            new Chart(appointmentCtx, {
                type: 'doughnut',
                data: {
                    labels: ['Có lịch hẹn', 'Chưa có lịch hẹn'],
                    datasets: [{
                        data: [
                            ${patientStats.patientsWithAppointments},
                            ${patientStats.totalPatients - patientStats.patientsWithAppointments}
                        ],
