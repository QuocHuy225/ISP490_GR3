...
<head>
    <meta charset="UTF-8">
    <title>Doctor Dashboard - Ánh Dương Clinic</title>
...
<body>
 <%
    ...
    <div class="container-fluid mt-4">
        <h2 class="mb-4">Tổng Quan Thống Kê Bác Sĩ</h2>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="stat-card bg-primary bg-opacity-10">
                    ...
                    <div class="stat-title">Tổng số lịch hẹn</div>
                    <div class="stat-value text-primary">${doctorStats.totalAppointments}</div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="stat-card bg-success bg-opacity-10">
                    ...
                    <div class="stat-title">Số bệnh nhân đã khám</div>
                    <div class="stat-value text-success">${doctorStats.uniquePatients}</div>
                </div>
            </div>
        </div>

        <!-- Nút dẫn đến báo cáo chi tiết -->
        <div class="row mt-4">
            <div class="col-md-4">
                <a href="${pageContext.request.contextPath}/doctor/report/appointment" class="btn btn-outline-info w-100 mb-3">
                    <i class="bi bi-bar-chart-line me-2"></i>Xem báo cáo lịch hẹn
                </a>
            </div>
        </div>
    </div>
