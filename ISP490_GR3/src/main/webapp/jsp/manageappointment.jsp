    ...
    <body>
                ...
                button.addEventListener('click', function (event) {
                    ...
                    if (confirmRemoveBtn) {
                        ...
                        newConfirmBtn.addEventListener('click', function () {
                            ...
                            const url2 = BASE_URL + "/appointments/remove-patient";
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // Track whether user has manually toggled
                ...
                // Responsive sidebar (only collapse on first load)
                function checkWidth() {
                    if (!userToggled) {
